const phrases = [
  ...
  {
    phrase: "La imaginación es más importante que el conocimiento.",
  ...
  {
    phrase: "No pretendas que las cosas cambien si siempre haces lo mismo.",
    author: "Albert Einstein",
    tags: ["negocio", "tecnología"],
    source: ""
  },
  {
    phrase:
      "No pierdas el tiempo centrándote en por qué no puedes hacer algo, que es lo que la mayoría hacen. Debes centrarte en que tal vez tú podrías, siendo así una de las excepciones.",
    author: "Steve Case de AOL",
    tags: ["negocio", "tecnología"],
    source: ""
  },
  {
